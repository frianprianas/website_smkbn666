                ...
                <section className="py-24 bg-gradient-to-br from-indigo-50 via-white to-blue-50">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
                            {kabarBaknus.slice(0, 5).map((kabar) => (
                                <motion.a 
                                    key={kabar.id}
                                ...
                                >
                                    ...
                                    <div className="p-8 flex flex-col flex-1">
                                        <div className="flex items-center gap-3 mb-6">
                                            ...
                                            <div>
                                                <p className="text-[9px] font-black text-blue-600 uppercase tracking-tighter">{kabar.source_name}</p>
                                                <p className="text-[8px] text-gray-400">{new Date(kabar.date_found).toLocaleDateString('id-ID')}</p>
                                            </div>
                                        </div>
                                        <h3 className="text-lg font-bold text-gray-900 mb-4 line-clamp-2 group-hover:text-blue-600 transition-colors leading-snug">
                                            {kabar.title}
                                        </h3>
                                        <p className="text-gray-500 text-xs leading-relaxed mb-6 line-clamp-3">
                                            {kabar.summary}
                                        </p>
                                        <div className="mt-auto flex items-center gap-2 text-blue-600 font-bold text-[10px] uppercase tracking-wider">
